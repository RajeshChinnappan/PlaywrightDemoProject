            ...
            //   def htmlFilePath = "${WORKSPACE}/playwright-report/index.html"
             ...
             //   def htmlContent = readFile(htmlFilePath).trim()
              //  echo "HTML Content: ${htmlContent}"
               ...
               emailext ( to: 'playwrightdemotesting@gmail.com,rajesh.c@reflectionsinfos.com,rajeshc2391@gmail.com', subject: 'Build Notification with HTML Report', body: """<p>Here is an image:</p><img src="https://example.com/image.png">""", mimeType: 'text/html',replyTo: '$DEFAULT_RECIPIENTS')
